...
public enum ErrorCode {
    ...
    // ========== 通知模块错误 12xxx ==========
    NOTIFICATION_DISABLED(12001, "通知功能未开启"),
    NOTIFICATION_RECIPIENT_EMPTY(12002, "通知收件人为空"),
    MCP_ENDPOINT_NOT_CONFIGURED(12003, "MCP 邮件服务地址未配置"),
    MCP_CALL_FAILED(12004, "MCP 邮件工具调用失败"),
    NOTIFICATION_TASK_NOT_FOUND(12005, "通知任务不存在"),
    NOTIFICATION_SEND_FAILED(12006, "通知发送失败");
